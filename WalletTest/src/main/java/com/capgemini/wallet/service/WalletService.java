...
public interface WalletService {
	...
	public WalletAccount createAccount(String userName, String contactNo, String password)throws WalletException, UserIdException,PhoneNumberException,UserNameException,PasswordException;
